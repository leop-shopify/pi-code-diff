...
describe("review action registry", () => {
  it("derives help and footer content from registered actions", () => {
    ...
    expect(help.find((section) => section.title === "Core")?.lines).toContain("1/2/3/4 toggle Navigator/Diff/Comments/PR context");
    ...
    expect(footer).toContain("1/2/3/4 toggle Navigator/Diff/Comments/PR context");
